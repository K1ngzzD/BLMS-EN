...
final class Login extends BaseController{
    ...
    public function login(){
        ...
        if(!empty($result) && $result['status'] == 1){
            ...
            $message = array("message"=>"This account has been reported lost, please contact the administrator to solve it","code"=>1);
        }else{
            $message = array("message"=>"Wrong account or password","code"=>1);
            //销毁验证码session使其重新生成
            $_SESSION = array();
            session_destroy();  
        }
